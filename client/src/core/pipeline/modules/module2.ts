...
示例输出：
{
  ...
  "styleAndGenre": {
    "artStyle": "水墨风格",
    "styleParameters": "淡墨渲染主体，笔触简洁不拖沓，留白处透着朦胧的室内光影",
    "referenceSource": ""
  },
  "sceneAndEnvironment": {
  ...
  "technicalParameters": {
    "resolution": "4K（平衡水墨风格的细节与生成速度）",
    "renderQuality": "水墨风格专用渲染，笔触晕染效果自然",
    "detailIntensity": "毛发用简练线条勾勒，不追求写实纹理，符合水墨简约感"
  },
  "negativePrompts": {
  ...
  "finalResult": "一只成年橘猫蜷在木质窗台上，橘色毛发用淡墨勾勒，毛尖晕着浅灰，一只眼睛是浓墨点的圆瞳，另一只泛着浅蓝。尾巴像一抹墨色拖在桌面，偶尔轻轻扫过窗沿。室内窗台铺着浅灰针织垫，窗台上放着一本翻开的线装书，书页边缘有些泛黄，猫爪偶尔碰一下书页。柔和的自然光从左侧窗户射入，在猫身上投下淡影，暖色调不刺眼。平视中景，居中构图，猫位于画面中心，背景轻微虚化，约60%占比突出猫的细节。4K分辨率，水墨风格专用渲染，笔触晕染效果自然，毛发用简练线条勾勒，符合水墨简约感。"
}`;
